...
1. Citra Landsat 8 Collection 2 (SR) difilter berdasarkan wilayah kajian (`geometry`) dan tutupan awan di bawah 20%, lalu di-composite menggunakan median per tahun.
